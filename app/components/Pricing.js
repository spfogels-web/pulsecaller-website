const PLANS = [
  ...
  },
  {
    ...
    price: "$799",
    cadence: "/ year",
    blurb: "Pay once for the year. Lock in your edge. Save ~$220 vs paying month-to-month.",
    cta: "Get Yearly",
    accent: "cyan",
    badge: null,
    features: [
      ...
      ["💎", "Save ~$220 vs paying month-to-month"],
    ],
    footnote: "≈ 2 months free vs monthly. Auto-renews yearly · cancel any time.",
  },
];
